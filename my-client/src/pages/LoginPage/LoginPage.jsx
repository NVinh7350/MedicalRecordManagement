...
const LoginPage = () => {
    ...
    useEffect(() => {
        ...
        if(loginSelect.user?.role === 'ADMIN') {
            // navigate(`/${loginSelect.user.role}`)
            navigate('/admin/user-list')
        } else if (loginSelect.user?.role === 'DOCTOR') {
            navigate('/doctor/find-patient')
                ...
                <form className="login-form">
                    <div className="text-field">
                        <input
                            ...
                            required={true}
                            onChange={(e) => handleInputChange("citizenId", e)}
                        />
                        <label>Số CMND</label>
                        {
                    ...
                    <div className="text-field">
                        ...
                        <div className="radio-login-container">
                            <div className="radio-login-column">
                                <label>Admin</label>
                                <input type="radio" name="role" value={'ADMIN'} checked={loginSelect?.loginInfo?.role==='ADMIN'} onChange={(e) => handleInputChange('role', e)}></input>
                            </div>
                            <div className="radio-login-column">
                                <label>Bác sĩ</label>
                                <input type="radio" name="role" value={'DOCTOR'} checked={loginSelect?.loginInfo?.role==='DOCTOR'} onChange={(e) => handleInputChange('role', e)}></input>
                            </div>
                            <div className="radio-login-column">
                                <label>Bệnh nhân</label>
                                <input type="radio" name="role" value={'PATIENT'} checked={loginSelect?.loginInfo?.role==='PATIENT'} onChange={(e) => handleInputChange('role', e)}></input>
                            </div>
