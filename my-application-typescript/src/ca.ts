...
const registerAndEnrollUser = async (caClient: FabricCAServices, orgMspId: string, userId: string,userPW:string,  affiliation: string): Promise<void> => {
    try {
