...
const initAPIRoute = (app: Express) => {
    ...
    router.post('/Auth/Doctor/updateMR', medicalRecordController.updateMR);
    router.get('/Auth/getDetailMR', medicalRecordController.getDetailMR);
    router.post('/Auth/Doctor/completedMR', medicalRecordController.completedMR);
